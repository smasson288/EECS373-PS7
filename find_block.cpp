...
void ImageConverter::imageCb(const sensor_msgs::ImageConstPtr& msg){
	...
	double scaledX = 0.002951 * (i_centroid - 320);
	double scaledY = 0.002951 * (j_centroid - 240);
        block_pose_.pose.position.x = (0.9788 * scaledX) - (0.204 * scaledY) + 0.545;
        block_pose_.pose.position.y = -1 * ((0.204 * scaledX) + (0.9788 * scaledY) - 0.317);
        double theta=-0.206;
